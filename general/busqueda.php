...
<script language="javascript">
	...
	function ValidarBusq()
	{
		with (document.form1)
		{
			if (numero.value == "" && num_mensaje.value == "" && tipo_proy.value == "" && tipo.value == "" && anio.value == "" && 
	...
	function Imprimir()
	{
		if (ValidarBusq())
		{
			with (document.form1)
			{
				action = 'busqueda.php?accion=imprimir';
				target = '_blank';
				submit();
			}
		}
	...
	function Buscar()
	{
		if (ValidarBusq())
		{
			with (document.form1)
			{
				action = 'busqueda.php?accion=buscar';
				target = '';
				submit();
			}
		}
...
<body>
<form action="busqueda.php?accion=buscar" method="post" name="form1" id="form1" onsubmit="return ValidarBusq();">
<div align="center">
    ...
    <td height="440" align="center" valign="top" class="contenido"><br />
        ...
        <table width="740" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
          ...
          <tr>
            ...
            <td align="left" class="td2"><input id="anio" name="anio" type="text" style="width:30px;" maxlength="4" onkeypress="return acceptNum(event)" value="" /></td>
      ...
      <br />
      <br />
      <input type="button" name="btnBuscarOtro" id="btnBuscarOtro" value="Buscar otro" style="width:150px" onclick="window.location = 'busqueda.php';" />
      <? if ($_SESSION['perfil'] != 'C') { ?>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" name="btnImprimir" id="btnImprimir" value="Imprimir" style="width:150px" onclick="Imprimir();" />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
